...
<body>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Choose Server</h1>
      <div class="page-header-actions">
        <ol class="breadcrumb">
          <li><a href="<?php echo base_url('clientarea'); ?>">Home</a></li>
          <li class="active"><a href="<?php echo base_url('clientarea/server'); ?>">Server</a></li>
        </ol>
      </div>
    </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><?php 
                            ...
                            echo $record['mata_uang']; echo " "; echo $r->harga;
                            }?></td>
                      <td><?php 
                            if ($r->kapasitas == '0'){
                               echo 'Sold Out';
                      ...
                      <td class="text-nowrap">
                        <a href="create/<?php echo $r->server_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"

            ...
            <div class="widget-header">
              <div class="widget-header-content">
                <a class="avatar avatar-lg" href="javascript:void(0)">
                  <img src="<?php echo base_url('assets/admin/images/pengaturan.png'); ?>" alt="PandaEver">
                </a>
                <div class="profile-user">PandaEver</div>
                <div class="profile-job">Web Development</div>
                <p>Powered By PandaEver </p>
                <div class="profile-social">
                  <a class="icon bd-github" href="https://github.com/JustPandaEver"></a>
                </div>

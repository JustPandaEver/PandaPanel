    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" href="<?php base_url('index.php/clientarea/deposit'); ?>" title="Balance" aria-expanded="false"
            data-animation="slide-bottom" role="button">
    ...
    <div class="page-header">
      ...
      <div class="page-header-actions">
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="<?php echo base_url('index.php/dashboard/account'); ?>">Account</a></li>
        </ol>
      </div>
    </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td class="text-nowrap">
                        <a href="delete_account/<?php echo $r->account_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="Create Account">

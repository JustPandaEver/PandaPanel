...
<head>
  ...
  <title>Server | <?php echo $record['nama_perusahaan']; ?></title>
...
<body>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Manage Server</h1>
      <div class="page-header-actions">
        <ol class="breadcrumb">
          <li><a href="<?php echo base_url('index.php/dashboard'); ?>">Home</a></li>
          <li class="active"><a href="<?php echo base_url('index.php/server'); ?>">Server</a></li>
        </ol>
      </div>
    </div>
            ...
            <div class="col-md-12">
              ...
              <div class="example-wrap">
                <h4 class="example-title">
                  <a href="<?php echo base_url('index.php/server/add'); ?>"><button type="button" class="btn btn-animate btn-animate-vertical btn-success">
                    <span><i class="icon wb-plus-circle" aria-hidden="true"></i>New Server</span>
                  </button></a>
                </h4>
                <div class="example table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td><?php echo $r->ip_server; ?></td>
                      <td><?php echo $r->lokasi; ?></td>
                      <td><?php echo $record['mata_uang']; echo " "; echo $r->harga; ?></td>
                      <td><?php echo $r->kapasitas; ?></td>
                      <td class="text-nowrap">
                        <a href="server/edit/<?php echo $r->server_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="Edit">
                          <i class="icon wb-wrench" aria-hidden="true"></i>
                        </button></a>
                        <a href="server/delete/<?php echo $r->server_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"

...
<head>
  ...
  <title>Users | <?php echo $record['nama_perusahaan']; ?></title>
            ...
            <div class="col-md-12">
              ...
              <div class="example-wrap">
                <h4 class="example-title">
                  <a href="<?php echo base_url('index.php/user/add'); ?>"><button type="button" class="btn btn-animate btn-animate-vertical btn-success">
                    <span><i class="icon wb-plus-circle" aria-hidden="true"></i>New User</span>
                  </button></a>
                </h4>
                <div class="example table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><?php echo $record['mata_uang']; echo " "; echo $r->saldo; ?></td>
                      <td><?php echo $r->last_login; ?></td>
                      <td class="text-nowrap">
                        <a href="user/edit/<?php echo $r->member_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="Edit">
                          <i class="icon wb-wrench" aria-hidden="true"></i>
                        </button></a>
                        <a href="user/delete/<?php echo $r->member_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"

...
<head>
  ...
  <title>Add Deposit | <?php echo $record['nama_perusahaan']; ?></title>
    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" href="<?php echo base_url('clientarea/deposit'); ?>" title="Balance" aria-expanded="false"
            data-animation="slide-bottom" role="button">
  ...
  <div class="page animsition">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('clientarea/deposit'); ?>">Deposit</a></li>
          ...
          <div class="row row-lg">
            ...
            <div class="col-md-12">
              ...
              <div class="example-wrap">
                <div class="example">
                  <?php echo form_open('clientarea/deposit', 'class="form-horizontal" autocomplete="off"'); ?>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Date Invoice</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="tgl_invoice" value="<?php echo date('Y-m-d') ?>" readonly="" />
                      </div>
                    </div>

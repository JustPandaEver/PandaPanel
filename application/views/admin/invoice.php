    ...
    <div class="page-header">
      ...
      <div class="page-header-actions">
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="<?php echo base_url('index.php/dashboard/invoice'); ?>">Invoice</a></li>
        </ol>
      </div>
    </div>
              ...
              <div class="example-wrap">
                ...
                <div class="example table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td><font color="green"><i class="icon wb-check" aria-hidden="true"></i></font></td>
                      <td><font color="green"><i class="icon wb-check" aria-hidden="true"></i></font></td>
                      ...
                      <?php } else { ?>
                      <td><font color="red"><p class="icon wb-close">Nothing Payment Proof</p></font></td>
                      <?php } ?>
                      
                      <td><?php echo $r->status; ?></td>
                      <td><a href="delete_invoice/<?php echo $r->invoice_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                    ...
                    <tr>
                      ...
                      <td class="text-nowrap">
                        <a href="approve_payment/<?php echo $r->invoice_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="Approve Payment">
                          <i class="icon wb-shopping-cart" aria-hidden="true"></i>
                        </button></a>
                        <a href="delete_invoice/<?php echo $r->invoice_id; ?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="Delete Payment">
                          <i class="icon wb-trash" aria-hidden="true"></i>
                        </button></a>
                      </td>

...
<head>
  ...
  <title>Add New Server | <?php echo $record['nama_perusahaan']; ?></title>
...
<body>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Server's</h1>
      <ol class="breadcrumb">
          ...
          <div class="row row-lg">
            ...
            <div class="col-md-12">
              ...
              <div class="example-wrap">
                <div class="example">
                  <?php echo form_open('server/add', 'class="form-horizontal" autocomplete="off"'); ?>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="type_url" placeholder="http://example.com/">
                      </div>
                    </div>
                    <div class="form-group">

...
<head>
  ...
  <title>Approve Payment | <?php echo $record['nama_perusahaan']; ?></title>
  ...
  <div class="page animsition">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('index.php/dashboard/approve_payment'); ?>">Approve</a></li>
          ...
          <div class="row row-lg">
            ...
            <div class="col-md-12">
              ...
              <div class="example-wrap">
                <div class="example">
                  <?php echo form_open('dashboard/approve_payment', 'class="form-horizontal" autocomplete="off"'); ?>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Deposit</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="deposit" value="<?php echo $lihat['deposit']; ?>" readonly />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Email</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="email" value="<?php echo $lihat['email']; ?>" readonly >
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="hidden" class="form-control" name="invoice_id" value="<?php echo $lihat['invoice_id']; ?>" readonly />
                      </div>
                    </div>

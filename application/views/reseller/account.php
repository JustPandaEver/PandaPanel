...
<head>
  ...
  <title>Account | <?php echo $record['nama_perusahaan']; ?></title>
    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" href="<?php base_url('clientarea/deposit'); ?>" title="Balance" aria-expanded="false"
            data-animation="slide-bottom" role="button">
    ...
    <div class="page-header">
      ...
      <div class="page-header-actions">
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="<?php echo base_url('clientarea/account'); ?>">Account</a></li>
        </ol>
      </div>
    </div>
              ...
              <div class="example-wrap">
                ...
                <div class="example table-responsive">
                  <table class="table table-bordered">
                    ...
                    $serper= $r->server_id;
                    $host = $this->db->query("SELECT * FROM server WHERE server_id = $serper ORDER BY ip_server ASC")->row_array();
                    $ips = $host['ip_server'];
                    $ovp = $host['link_config'];
                    ?>

                    <tr>
                      <td><?php echo $ips.' / '.gethostbyname($ips); ?></td>
                      <td><?php echo $r->username_ssh; ?></td>
                      <td><?php echo $r->password_ssh; ?></td>
                      <td><?php echo $r->tgl_buat; ?></td>
                      <?php if ($r->expired_account >= date('Y-m-d')) { ?>
                      <td><font color="red"><?php echo $r->expired_account; ?></font></td>
                      <?php } else { ?>
                      <td><?php echo $r->expired_account; ?></td>
                      <?php } ?>
                      <td class="text-nowrap">
                        <a href="#"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="Renew Account">
                            <i class="icon wb-shopping-cart" aria-hidden="true"></i>
                            </button>
                            <td class="text-nowrap">
                            <a href="<?php echo $ovp ;?>"><button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"

...
<head>
  ...
  <title>Dashboard | <?php echo $record['nama_perusahaan']; ?></title>
                    ...
                    <div class="counter-label">
                      ...
                      <div class="counter counter-sm text-left">
                        <div class="counter-number-group">
                          ...
                          <a href="server"><button type="button" class="btn btn-primary padding-horizontal-40">View All Server</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-xlg-12 col-md-6" style="height:50%;">
              ...
              <div class="widget widget-shadow">
                <div class="widget-content widget-radius padding-30 bg-red-600 white">
                  <div class="counter counter-lg counter-inverse text-left">
                    <div class="counter-label margin-bottom-20">
                      <div>USER'S REGISTERED</div>
                    </div>
                    <div class="counter-number-group margin-bottom-10">
                      <span class="counter-number-related"></span>
                      <span class="counter-number"><?php echo $member->num_rows(); ?></span>
                    </div>
                    <div class="counter-label">
                      ...
                      <div class="counter counter-sm text-left">
                        <div class="counter-number-group">
                          <span class="counter-number font-size-14"></span>
                          <a href="user"><button type="button" class="btn btn-danger padding-horizontal-40">View All User's</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="counter counter-lg counter-inverse text-left">
                    ...
                    <div class="counter-label">
                      ...
                      <div class="counter counter-sm text-left">
                        <div class="counter-number-group">
                          <span class="counter-number font-size-14"></span>
                          <a href="dashboard/account"><button type="button" class="btn btn-success padding-horizontal-40">View All Account</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="counter counter-lg counter-inverse text-left">
                    ...
                    <div class="counter-label">
                      ...
                      <div class="counter counter-sm text-left">
                        <div class="counter-number-group">
                          <span class="counter-number font-size-14"></span>
                          <a href="dashboard/invoice"><button type="button" class="btn btn-warning padding-horizontal-40">View All Invoice</button></a>
                        </div>
                      </div>
                    </div>
                  </div>

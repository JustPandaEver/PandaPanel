...
<head>
  ...
  <title>Edit Server | <?php echo $record['nama_perusahaan']; ?></title>
...
<body>
  ...
  <div class="page animsition">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('index.php/server'); ?>">Server's</a></li>
          ...
          <div class="row row-lg">
            ...
            <div class="col-md-12">
              ...
              <div class="example-wrap">
                <div class="example">
                  <?php echo form_open('server/edit', 'class="form-horizontal" autocomplete="off"'); ?>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Location (Data Center)</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="lokasi" value="<?php echo $lihat['lokasi']; ?>" required />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Host (IP Server)</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="host" value="<?php echo $lihat['ip_server']; ?>" required >
                      </div>
                    </div>
                    <?php if (!empty($error)) {?>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Maximum Account</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="kapasitas" value="<?php echo $lihat['kapasitas']; ?>" required >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Link Config</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="link_config" value="<?php echo $lihat['link_config']; ?>" required />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Price</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="harga" value="<?php echo $lihat['harga']; ?>" required >
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label"></label>
                      <div class="col-sm-9">
                        <input type="hidden" class="form-control" name="id_server" value="<?php echo $lihat['server_id']; ?>" required />
                      </div>
                    </div>
  ...
  <footer class="site-footer">
    ...
    <div class="site-footer-right">
      Powered By <a href="http://pandaever.com/">PandaEver</a>
    </div>
  </footer>
